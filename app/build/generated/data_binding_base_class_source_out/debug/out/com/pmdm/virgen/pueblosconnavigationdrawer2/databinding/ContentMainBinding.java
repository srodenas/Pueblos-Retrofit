...
public final class ContentMainBinding implements ViewBinding {
  ...
  @NonNull
  public final FragmentContainerView contenedor;

  private ContentMainBinding(@NonNull LinearLayout rootView,
      @NonNull FragmentContainerView contenedor) {
  ...
  public static ContentMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.contenedor;
      FragmentContainerView contenedor = ViewBindings.findChildViewById(rootView, id);
      if (contenedor == null) {
        break missingId;
      }

      return new ContentMainBinding((LinearLayout) rootView, contenedor);
    }
